        ...
        with tab_aq:
            ...
            if len(df_hr_l) > 0 or len(df_o2_l) > 0:
                ...
                fig_s.update_layout(**PLOTLY_WHITE,
                    ...
                    legend=LEGEND_STYLE)
                st.plotly_chart(fig_s, use_container_width=True, config={'displayModeBar': False, 'responsive': True, 'scrollZoom': False})
            ...
            for tipo_t, cols_t, cores_t, sec_key, unid_t, cor_eixo in [
                ...
                fig_t.update_layout(**PLOTLY_WHITE,
                    ...
                    legend=LEGEND_STYLE)
                st.plotly_chart(fig_t, use_container_width=True, config={'displayModeBar': False, 'responsive': True, 'scrollZoom': False})
            ...
            if pwr_cols and 'DATA' in df_a.columns:
                ...
                fig_pwr.update_layout(**PLOTLY_WHITE,
                    ...
                    legend=LEGEND_STYLE)
                st.plotly_chart(fig_pwr, use_container_width=True, config={'displayModeBar': False, 'responsive': True, 'scrollZoom': False})
                st.markdown("---")
            ...
            if drag_col:
                ...
                if len(df_drag) >= 2:
                    ...
                    fig_drag.update_layout(**PLOTLY_WHITE,
                        ...
                        legend=LEGEND_STYLE)
                    st.plotly_chart(fig_drag, use_container_width=True, config={'displayModeBar': False, 'responsive': True, 'scrollZoom': False})
